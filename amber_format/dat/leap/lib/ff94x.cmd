...
#	libraries for the 1994 Cornell et al. force field.
#
#
#    nucleic acids..
#
...
set   RCN     tail       null
#
saveOff a ./all_nucleic94.lib
saveOff b ./all_nucleic94.lib
saveOff c ./all_nucleic94.lib
saveOff d ./all_nucleic94.lib
saveOff e ./all_nucleic94.lib
saveOff f ./all_nucleic94.lib
saveOff g ./all_nucleic94.lib
saveOff h ./all_nucleic94.lib
#
#    amino acids..
#
################################################
...
clearVariables
#
# Extract the amino acids from all_amino94x.in
#
loadAmberPrep all_amino94x.in 
...
loadAmberPrep all_aminont94x.in N
...
saveOff a ./all_aminont94x.lib 

#
# Extract the C terminus residues
#

loadAmberPrep all_aminoct94x.in C
