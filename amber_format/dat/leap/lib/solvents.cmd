...
#
#	TIP4P/2005 water (Abascal&Vega)
#

h1 = createAtom  H1   HW  0.5564
h2 = createAtom  H2   HW  0.5564
o  = createAtom  O    OW  0.0
ep = createAtom  EPW  EP  -1.1128
...
add T45  r
set T45.1   restype   solvent
set T45.1   imagingAtom  T45.1.O

zMatrix T45  {
	{  H1  O 0.9572 }
	{  H2  O  H1 0.9572 104.52 }
	{  EPW O  H1  H2  0.1546  52.26  0.0  }
}
...
a = { TP3 TPF SPC TP4 T4E T45 DC4 TP5 PL3 SPF SPG TIP3PBOX TIP3PFBOX TIP4PBOX TIP4PEWBOX TIP4P2005BOX TIP5PBOX SPCBOX QSPCFWBOX SPCFWBOX POL3BOX CHCL3BOX MEOHBOX NMABOX }
