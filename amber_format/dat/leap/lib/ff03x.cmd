...
clearVariables
#
# Extract the amino acids from all_amino03x.in
#
loadAmberPrep all_amino03x.in 
...
loadAmberPrep all_aminont03x.in
...
set a        restype   protein
saveOff a ./all_aminont03x.lib 

#
# Extract the C terminus residues
#

loadAmberPrep all_aminoct03x.in
